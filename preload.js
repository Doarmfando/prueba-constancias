...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  registros: {
    ...
    eliminar: (id, usuario) => ipcRenderer.invoke("eliminarRegistro", { id, usuario }),
    buscarPorDni: (dni) => ipcRenderer.invoke("buscar-por-dni", dni),
    actualizarMultiple: (datos, usuario) => ipcRenderer.invoke("actualizarMultiple", { datos, usuario }),
    moverAPapeleraMultiple: (ids, usuario) => ipcRenderer.invoke("mover-a-papelera-multiple", { ids, usuario }),
    restaurarMultiple: (ids, usuario) => ipcRenderer.invoke("restaurar-registro-multiple", { ids, usuario }),
    eliminarMultiple: (ids, usuario) => ipcRenderer.invoke("eliminar-registro-multiple", { ids, usuario }),
